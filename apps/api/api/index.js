...
// src/modules/example/router.ts
function createExampleRouter() {
  return t.router({
    hello: t.procedure.input(z.string()).output(z.string()).query(({ input }) => `${input} world`)
  });
}
__name(createExampleRouter, "createExampleRouter");
...
__name(createApiRouter, "createApiRouter");
...
// ../../packages/yas-zod/src/types/mode.ts
var mode = z.enum([
  "development",
  "production"
]);

// ../../packages/yas-zod/src/types/truthy.ts
var truthyString = z.string().transform((v) => [
  "true",
  "1"
].includes(v.toLowerCase()));
var truthy = z.boolean().or(truthyString);

// src/zod/morganFormat.ts
var morganFormat = z.enum([
  "tiny",
  "short",
  "dev",
  "combined"
...
function createServer() {
  const app = express();
  app.use(env.trpcPath, trpcExpress.createExpressMiddleware({
...
// src/entrypoints/prod.ts
var prod_default = createServer();
export {
  prod_default as default
};
