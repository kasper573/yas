...
When working with async UI flows like modals, toasts, drawers, etc.
it's often preferable to have an imperative and promise based interface, which is what this library provides.
